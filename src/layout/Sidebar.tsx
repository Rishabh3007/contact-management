...
function Sidebar() {
  ...
  return (
    <div className={`absolute sm:relative sm:top-0 sm:left-0 min-h-full w-40 sm:w-[18%] z-50 bg-gray-800 transition duration-300 ease-in-out transform ${isSidebarOpen ? '-translate-x-full' : '-translate-x-0'} sm:translate-x-0`}>
